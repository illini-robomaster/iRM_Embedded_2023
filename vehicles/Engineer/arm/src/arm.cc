...
//     target.forearm_rotate = (sbus->ch[6]);
//     target.wrist_rotate = (sbus->ch[7]);
//     target.hand_rotate = (sbus->ch[8]);
...
//        forearm_rotate_motor->SetOutput(0,M4310_VEL,0.1,0.1,0);
        ...
        set_cursor(0, 0);
        clear_screen();
        print("Target( H:%.3f W:%.3f F:%.3f )", target.hand_rotate, target.wrist_rotate, target.forearm_rotate);
        print("Current( H:%.3f W:%.3f F:%.3f\r\n )", current_joint_state.hand_rotate,current_joint_state.wrist_rotate,current_joint_state.forearm_rotate);
...
//   current_joint_state.base_translate = target->base_translate;
  ...
  // A1->Control(BASE_VERT_ROTATE_ID, 0.0, 0.0, current_joint_state.base_vert_rotate,  A1_Kp, A1_Kd);
  ...
  // A1->Control(BASE_HOR_ROTATE_ID, 0.0, 0.0, current_joint_state.base_hor_rotate,  A1_Kp, A1_Kd);
  ...
  // A1->Control(ELBOW_ROTATE_ID, 0.0, 0.0, current_joint_state.elbow_rotate,  A1_Kp, A1_Kd);
